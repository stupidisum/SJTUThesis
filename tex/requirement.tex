...
\begin{figure}[!htp]
 \centering
 \includegraphics[width=0.99\textwidth]{data_model.png}
...
\begin{figure}[!htp]
 \centering
 \includegraphics[width=0.9\textwidth]{pdf/azwraith_prototype.pdf}
 \bicaption[fig:azwraith_mockup_2]{Smart City模块原型}{Smart City模块原型}{Fig}{Smart City module’s mockups}
\end{figure}

\subsection{设计稿}
但后来因为这个模块比较重要，而且不像版本管理模块不是非常注重UI，公司又请专门的设计师给出了一个设计稿，如图3-6和3-7所示。
\begin{figure}[!htp]
 \centering
 \includegraphics[width=0.9\linewidth]{azwraith_login.jpg}
 \bicaption[fig:azwraith_login]{Smart City模块登录页面}{Smart City模块登录页面}{Fig}{Login page of Smart City module}
\end{figure}
\begin{figure}[!htp]
 \centering
 \includegraphics[width=0.9\linewidth]{azwraith_smart_city.jpg}
 \bicaption[fig:azwraith_smart_city]{Smart City模块首页}{Smart City模块首页}{Fig}{Home page of Smart City module}
\end{figure}
